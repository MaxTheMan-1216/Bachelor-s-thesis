...
Orsaken till att AI har blivit ett viktigt verktyg för att motverka social engineering-attacker är dess förmåga att analysera stora mängder data och identifiera mönster 
...
upprätthållas i realtid. Enligt \cite{abir2023ai_social_engineering} kan AI även användas för att förstärka användarstöd och beslutsfattande. Genom specialiserade varningssystem 
...
Även om AI erbjuder avancerade möjligheter för detektion och respons med hjälp av ML, är teknologin ingen universallösning mot social engineering. Eftersom ML är grunden för AI påverkas AI indirekt av samma brister som 
ML drabbas av. AI-baserade system är därmed beroende av inlärningsdata, modellarkitektur och uppdateringar. Om träningsdata är bristfälliga eller utsätts för en fientlig attack, kan modellen utveckla brister i 
sin klassificeringsförmåga \cite{basnet2023anti_phishing, algarni2024comprehensive_taxonomy}. Därtill kvarstår det centrala problemet med AI, vilket är att hotaktörerna också använder sig av AI. Användningen av AI 
...
kan identifiera och blockera många sorters angrepp, men den mänskliga faktorn kvarstår i beslutsprocesser och beteendemönster. Specifikt för organisationer spelar säkerhetskultur, utbildningsnivå och interna rutiner en avgörande 
roll i hur motståndskraftiga de är mot social engineering \cite{washo2021interdisciplinary}. Trots de olika motåtgärderna är utbildnings- och medvetandeprogram bland de mest använda. Enligt \cite{albladi2019training_awareness} är 
dessa utbildningsprogram däremot bristfälliga, eftersom utbildningen ofta erbjuds endast några gånger istället för kontinuerligt. För att uppnå ett effektivt skydd bör utbildningen vara återkommande, scenariobaserad och anpassad 
...
anpassa utbildningsinsatser i efterhand. Samtidigt måste även dessa simuleringar genomföras med hänsyn till organisatorisk tillit och arbetsmiljö, eftersom övervakning kan påverka arbetarnas upplevelse och trygghet.
